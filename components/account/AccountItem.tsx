...
const PROVIDER_LOGOS: Record<string, string> = {
  ...
  bni:        'https://logo.clearbit.com/bni.co.id',
  cimb:       'https://logo.clearbit.com/cimbniaga.co.id',
  jago:       'https://logo.clearbit.com/jago.com',
  jenius:     'https://logo.clearbit.com/jenius.com',
  bsi:        'https://logo.clearbit.com/bankbsi.co.id',
  permata:    'https://logo.clearbit.com/permatabank.com',
  danamon:    'https://logo.clearbit.com/danamon.co.id',
  ocbc:       'https://logo.clearbit.com/ocbc.id',
  btn:        'https://logo.clearbit.com/btn.co.id',
  sinarmas:   'https://logo.clearbit.com/banksinarmas.com',
  panin:      'https://logo.clearbit.com/panin.co.id',
  mega:       'https://logo.clearbit.com/bankmega.com',
  gopay:      'https://logo.clearbit.com/gojek.com',
  ovo:        'https://logo.clearbit.com/ovo.id',
  dana:       'https://logo.clearbit.com/dana.id',
  shopeepay:  'https://logo.clearbit.com/shopee.co.id',
  linkaja:    'https://logo.clearbit.com/linkaja.id',
  flip:       'https://logo.clearbit.com/flip.id',
}
